...
ActiveRecord::Schema[8.0].define(version: 2025_04_23_115205) do
  ...
  create_table "product_stocks", force: :cascade do |t|
    ...
    t.index ["store_id"], name: "index_product_stocks_on_store_id"
  end
  ...
  add_foreign_key "product_stocks", "stores"
